                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-2">
                                                <div class="position-relative mb-3">
                                                    ...
                                                    <input type="number" value="0" class="form-control" id="baik" name="baik" required />
                                                    <div class="invalid-tooltip">
                                                        Tidak Boleh Kosong
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12 col-md-2">
                                                <div class="position-relative mb-3">
                                                    ...
                                                    <input type="number" value="0" class="form-control" id="sedang" name="sedang" required />
                                                    <div class="invalid-tooltip">
                                                        Tidak Boleh Kosong
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12 col-md-2">
                                                <div class="position-relative mb-3">
                                                    ...
                                                    <input type="number" value="0" class="form-control" id="rusak" name="rusak" required />
                                                    <div class="invalid-tooltip">
                                                        Tidak Boleh Kosong
                                                    </div>
                                                </div>
